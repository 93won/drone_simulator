...
{
  px4_msgs__msg__LongitudinalControlConfiguration * msg = (px4_msgs__msg__LongitudinalControlConfiguration *)malloc(sizeof(px4_msgs__msg__LongitudinalControlConfiguration));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__LongitudinalControlConfiguration__Sequence__init(px4_msgs__msg__LongitudinalControlConfiguration__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__LongitudinalControlConfiguration *)calloc(size, sizeof(px4_msgs__msg__LongitudinalControlConfiguration));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__LongitudinalControlConfiguration__Sequence * array = (px4_msgs__msg__LongitudinalControlConfiguration__Sequence *)malloc(sizeof(px4_msgs__msg__LongitudinalControlConfiguration__Sequence));
  if (!array) {
    return NULL;
  }
