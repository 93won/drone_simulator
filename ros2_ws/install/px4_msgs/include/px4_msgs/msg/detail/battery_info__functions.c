...
{
  px4_msgs__msg__BatteryInfo * msg = (px4_msgs__msg__BatteryInfo *)malloc(sizeof(px4_msgs__msg__BatteryInfo));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__BatteryInfo__Sequence__init(px4_msgs__msg__BatteryInfo__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__BatteryInfo *)calloc(size, sizeof(px4_msgs__msg__BatteryInfo));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__BatteryInfo__Sequence * array = (px4_msgs__msg__BatteryInfo__Sequence *)malloc(sizeof(px4_msgs__msg__BatteryInfo__Sequence));
  if (!array) {
    return NULL;
  }
