...
{
  px4_msgs__msg__FixedWingLateralSetpoint * msg = (px4_msgs__msg__FixedWingLateralSetpoint *)malloc(sizeof(px4_msgs__msg__FixedWingLateralSetpoint));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__FixedWingLateralSetpoint__Sequence__init(px4_msgs__msg__FixedWingLateralSetpoint__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__FixedWingLateralSetpoint *)calloc(size, sizeof(px4_msgs__msg__FixedWingLateralSetpoint));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__FixedWingLateralSetpoint__Sequence * array = (px4_msgs__msg__FixedWingLateralSetpoint__Sequence *)malloc(sizeof(px4_msgs__msg__FixedWingLateralSetpoint__Sequence));
  if (!array) {
    return NULL;
  }
