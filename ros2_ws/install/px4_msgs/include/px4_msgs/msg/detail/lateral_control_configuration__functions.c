...
{
  px4_msgs__msg__LateralControlConfiguration * msg = (px4_msgs__msg__LateralControlConfiguration *)malloc(sizeof(px4_msgs__msg__LateralControlConfiguration));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__LateralControlConfiguration__Sequence__init(px4_msgs__msg__LateralControlConfiguration__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__LateralControlConfiguration *)calloc(size, sizeof(px4_msgs__msg__LateralControlConfiguration));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__LateralControlConfiguration__Sequence * array = (px4_msgs__msg__LateralControlConfiguration__Sequence *)malloc(sizeof(px4_msgs__msg__LateralControlConfiguration__Sequence));
  if (!array) {
    return NULL;
  }
