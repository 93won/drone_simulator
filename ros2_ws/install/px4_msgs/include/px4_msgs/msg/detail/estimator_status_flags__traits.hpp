  ...
  std::ostream & out, size_t indentation = 0)
{
  ...
  // member: cs_gnss_pos
  {
    ...
    out << "cs_gnss_pos: ";
    value_to_yaml(msg.cs_gnss_pos, out);
    out << "\n";
  }
  ...
  // member: cs_baro_fault
  {
    ...
    out << "cs_baro_fault: ";
    value_to_yaml(msg.cs_baro_fault, out);
    out << "\n";
  }
  ...
  // member: cs_gnss_vel
  {
    ...
    out << "cs_gnss_vel: ";
    value_to_yaml(msg.cs_gnss_vel, out);
    out << "\n";
  }
  ...
  // member: cs_gnss_fault
  {
    ...
    out << "cs_gnss_fault: ";
    value_to_yaml(msg.cs_gnss_fault, out);
    out << "\n";
  }
  ...
  // member: cs_yaw_manual
  {
    ...
    out << "cs_yaw_manual: ";
    value_to_yaml(msg.cs_yaw_manual, out);
    out << "\n";
  }
  ...
  // member: cs_gnss_hgt_fault
  {
    ...
    value_to_yaml(msg.cs_gnss_hgt_fault, out);
    out << "\n";
  }
