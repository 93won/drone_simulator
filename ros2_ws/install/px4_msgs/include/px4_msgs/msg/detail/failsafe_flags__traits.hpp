  ...
  std::ostream & out, size_t indentation = 0)
{
  ...
  // member: mode_req_global_position_relaxed
  {
    ...
    value_to_yaml(msg.mode_req_global_position_relaxed, out);
    out << "\n";
  }
  ...
  // member: global_position_invalid_relaxed
  {
    ...
    value_to_yaml(msg.global_position_invalid_relaxed, out);
    out << "\n";
  }
  ...
  // member: position_accuracy_low
  {
    ...
    value_to_yaml(msg.position_accuracy_low, out);
    out << "\n";
  }
